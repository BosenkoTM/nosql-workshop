...
### Вариант 2, 12, 22 Корзина покупок интернет-магазина
...
### Вариант 3, 13, 23 Система рейтингов товаров
...
### Вариант 4, 14 Кэш для API запросов
...
### Вариант 5, 15 Система уведомлений
...
### Вариант 7, 17 Система голосования
...
### Вариант 9, 19 Система бронирования
...
- Обработка ошибок подключения и исключительных ситуаций
- Использование connection pooling для повышения производительности
- Логирование операций и ошибок
- Юнит-тесты для основных функций (минимум 5 тестов на вариант)

### Структура проекта:
```
project/
├── main.py              # Основной модуль с реализацией
├── config.py            # Конфигурация Redis подключения
├── tests/               # Директория с тестами
│   └── test_main.py     # Тесты основного функционала
...
- **Схема данных в Redis** с описанием используемых ключей
...
class RedisManager:
    ...
    # Здесь реализовать методы согласно варианту задания
```

### Дополнительные задачи (по желанию, для повышения оценки):
- Реализация веб-интерфейса (Flask/FastAPI) (+1 балл).
- Docker-контейнеризация (+0.5 балла).
- Использование Redis Pub/Sub (+1 балл).
- Реализация кэширования с различными стратегиями (+0.5 балла).
- Мониторинг производительности и метрики (+0.5 балла).

### Срок выполнения:
- **2 недели** с момента получения задания.
- Промежуточная проверка через 1 неделю (демонстрация базового функционала).

### Защита проекта:
Каждый студент должен подготовить:
1. Демонстрацию работы программы (5-7 минут).
2. Объяснение ключевых решений и архитектуры (3-5 минут).
