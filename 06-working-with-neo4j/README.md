...
Варианты заданий представлены на платформе 

2 курс МГПУ [Практическая работа 4. Графовая аналитика данных с использованием Neo4j: анализ связей и построение рекомендательных систем](http://95.131.149.21/moodle/mod/assign/view.php?id=1290)

4 курс МГПУ [Лабораторная работа 2.1. Изучение методов хранения данных на основе NoSQL](http://95.131.149.21/moodle/mod/assign/view.php?id=895) 
